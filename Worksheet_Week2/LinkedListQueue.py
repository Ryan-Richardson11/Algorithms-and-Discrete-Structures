...
queue = LinkedList()
queue.insertCurrentNext("a")
queue.insertCurrentNext("b")
queue.insertCurrentNext("c")
queue.insertCurrentNext("d")
queue.insertCurrentNext("e")
queue.printList()
print(queue.removeBeginning())
print(queue.removeBeginning())
print(queue.removeBeginning())
print(queue.removeBeginning())
print(queue.removeBeginning())
